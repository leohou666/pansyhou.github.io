...
const sidebars = {
  skill: [
    ...
    {
      label: 'Data-Sturcture',
      type: 'category',
      link: {
        type: 'doc',
        id: 'skill/DataStructure/01-liner-list'
      },
      items: [
        'skill/DataStructure/01-liner-list',
        'skill/DataStructure/02-string',
        'skill/DataStructure/05-tree',
        'skill/DataStructure/06-graph',
        // {
        //   type: 'autogenerated',
...

    {
      ...
      items: [
        ...
        'skill/Operating-System/diy-pstree'
        // {
        //   type: 'autogenerated',
    ...
    },
    {
      ...
      items: [
        ...
        'skill/Computer-Organization/Wrong-question-book',
        'skill/Computer-Organization/digit-system'
        // {
        //   type: 'autogenerated',
        //   dirName: 'skill/Computer-Organization', // '.' means the current docs folder
        // },
    ...
    },
    {
      ...
      link: {
        type: 'doc',
        id: 'skill/Linux/zdyzlinuxarch'
      },
      items: [
        // 'skill/Linux/man',
        // 'skill/Linux/njuics2022',
        'skill/Linux/keyboardSetting',
        'skill/Linux/openwrtnote1',
        'skill/Linux/zdyzlinuxarch',
        'skill/Linux/zdyzlinuxsys',
        'skill/Linux/zdyzlinuxsys2',
        'skill/Linux/arm-driver-dev1',
        'skill/Linux/arm-driver-dev2',
        'skill/Linux/arm-driver-dev3',
        // {
        //   type: 'autogenerated',
        //   dirName: 'skill/Computer-Organization', // '.' means the current docs folder
        // },
  ...
  zynq:[
    {
      type: 'autogenerated',
      dirName: 'zynq', // '.' means the current docs folder
    },
  ],
  // ysyx: [
  //   // 'oi/introduction',
  ...
  //   {
  //     type: 'autogenerated',
  //     dirName: 'ysyx', // '.' means the current docs folder
  //   },
  //   // 'oi/two_sum', 
  ...
  stm32: [
    ...
    'stm32/embedded-C-self-cultivation',
    'stm32/usb-application'
  ],
  ros: [
    'ros/two_degree_arm',
    'ros/wsl2_ros',
